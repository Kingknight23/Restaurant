...
/**
 * Loads sample reservation data into the given restaurant.
 *
 * Parameters:
 * - r (RestaurantType*): A pointer to the restaurant structure to load data into. -output parameter
 *
 * Returns: None
 */
...
/**
 * Loads sample patron data into the given restaurant.
 *
 * Parameters:
 * - r (RestaurantType*): A pointer to the restaurant structure to load data into. -output parameter
 *
